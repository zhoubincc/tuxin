<template>
	<view class="page_container">
		...
		<view class="input_content">
			<my-avatar :src="sourceInfo.faceURL" :desc="sourceInfo.nickname" :isGroup="isGroup"
				size="42" />
			<u--input placeholder="请输入内容" border="none" v-model="content" clearable></u--input>
		</view>

		<view class="action_row">
			<u-button :loading="updateLoading" :disabled="!content && !isGroupMember" @click="comfirmUpdate" text="完成" type="primary">
			</u-button>
		</view>
	</view>
</template>
