<template>
	<view @click="toMemberList" class="member_row">
		...
		<view class="member_list">
			...
			<image style="width: 36px;height: 36px;min-width: 36px;" @click.stop="inviteMember" class="member_item" src="@/static/images/group_setting_invite.png" alt="">
			<image style="width: 36px;height: 36px;min-width: 36px;" @click.stop="kickMember" v-if="!isNomal" class="member_item" src="@/static/images/group_setting_remove.png"
				alt="">
		</view>
	</view>
</template>
