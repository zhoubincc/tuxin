	...
	<view class="preview_file_container">
		...
		<view class="main_area">
			...
			<view class="doload_action">
				<u-icon v-if="downloadUrl" @click="openFile" name="share-square" label="打开" size="32"></u-icon>
				<u-icon v-if="!downloading && !downloadUrl" @click="download" name="download" label="下载" size="32">
				</u-icon>
				<u-loading-icon v-if="downloading" mode="semicircle" text="下载中"></u-loading-icon>
			</view>
		</view>
