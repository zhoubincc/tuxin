<template>
	<view class="page_container">
		...
		<view class="info_wrap">
			<setting-item :loading="loadingState.beep" @switch="changeBeep" :switchValue="selfInfo.allowBeep === 1"
				title="声音" :is_switch="true" />
			<!-- <setting-item title="群声音" :is_switch="true" /> -->
			<setting-item :loading="loadingState.vibration" @switch="changeVibration"
				:switchValue="selfInfo.allowVibration === 1" title="震动" :is_switch="true" />
		</view>
	</view>
</template>
