...
<!-- 	<u-upload @click-upload="setBannerMax" :fileList="fileList1" :uploadText="uploadText1"
						:previewFullImage="true" @afterRead="afterRead" @delete="deletePic" name="1" multiple
						:maxCount="9" accept="image" uploadIcon="plus" capture="['album', 'camera']" width="100"
						height="100"> -->
