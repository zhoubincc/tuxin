...
const actions = {
	getFriendList({
		...
		IMSDK
			.compatibleAPI(IMSDK.IMMethods.GetFriendList, uuidv4())
			.then(({
				data
			}) => {
	...
	getGrouplist({
		...
		IMSDK
			.compatibleAPI(IMSDK.IMMethods.GetJoinedGroupList, uuidv4())
			.then(({
				data
			}) => {
	...
	getBlacklist({
		...
		IMSDK
			.compatibleAPI(IMSDK.IMMethods.GetBlackList, uuidv4())
			.then(({
				data
			}) => {
	...
	getRecvFriendApplications({
		...
		IMSDK
			.compatibleAPI(IMSDK.IMMethods.GetRecvFriendApplicationList, uuidv4())
			.then(({
				data
			}) => {
	...
	getSentFriendApplications({
		...
		IMSDK
			.compatibleAPI(IMSDK.IMMethods.GetSendFriendApplicationList, uuidv4())
			.then(({
				data
			}) => {
	...
	getRecvGroupApplications({
		...
		IMSDK
			.compatibleAPI(IMSDK.IMMethods.GetRecvGroupApplicationList, uuidv4())
			.then(({
				data
			}) => {
	...
	getSentGroupApplications({
		...
		IMSDK
			.compatibleAPI(IMSDK.IMMethods.GetSendGroupApplicationList, uuidv4())
			.then(({
				data
			}) => {
